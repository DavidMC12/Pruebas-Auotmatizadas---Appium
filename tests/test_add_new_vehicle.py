...
def addNewVehicle(driver):
    ...
    CYLINDER_SELECTOR_XPATH = '//android.widget.FrameLayout[@resource-id="android:id/content"]/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]/android.view.View/android.widget.EditText[4]'
    ...
    try:
        ...
        # driver.tap([(screen_size['width'] * 0.5, screen_size['height'] * 0.17)], 500)
        # time.sleep(2)
        ...
        brand_vehicle.click()
        brand_vehicle.send_keys("Prueba Automatizada")
        driver.back()
        ...
        plates_vehicle.send_keys("EFE000")
        driver.back()
        ...
        document_number.send_keys("10000001")
        driver.back()
